        ...
        <div class="contend">
            ...
            <div class="search">
                <el-form ref="form" label-width="80px">
                    <el-form-item label="名称">
                        <input v-model="search" @keydown.13="searchdata" class="hot"></input>
                    </el-form-item>
            ...
            <el-table
                ...
                <el-table-column label="操作">
                    <template slot-scope="scope">
                       <router-link :to="{name:'shsjgl',query:{sid:scope.row.sid,num:3}}"  tag="el-button">编辑</router-link>
                        <el-button
                                size="mini"
                                type="danger"
...
<script>
    ...
    export default {
        ...
        methods:{
            getdata(){
                 this.axios.get('/admin/check/shoplist?status=2&page='+this.currentPage+'&search='+this.search).then(res=>{
...
<style scoped>
    ...
    .left .bottom li.hot .shu{
        opacity: 1;
    }
    .left .bottom li.hot .hen{
        background-color: #35dc82;
        box-shadow: 0 2px 5px 0 rgba(68, 181, 255, 0.43);
    }
    .con .contend{
        width: 1000px;
