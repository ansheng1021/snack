        ...
        <div class="contend">
            ...
            <el-table
                ...
                <el-table-column label="操作">
                    <template slot-scope="scope">
                       <router-link :to="{name:'shsjgl',query:{sid:scope.row.sid,num:2}}"  tag="el-button">编辑</router-link>
                        <el-button
                                size="mini"
                                type="danger"
...
<script>
    ...
    export default {
        ...
        methods:{
            getdata(){
                 this.axios.get('/admin/check/shoplist?status=1&page='+this.currentPage+'&search='+this.search).then(res=>{
